<?php 
	...
	class DmiBgrGradingReportTable extends Table{

		var $name = "DmiBgrGradingReport";
	  ...
	  $DmiBgrGradingReportAddMoreDetails = TableRegistry::getTableLocator()->get('DmiBgrGradingReportAddMoreDetails');
    $greding_report_details = $DmiBgrGradingReportAddMoreDetails->gredingReportDetails();	
		
	  $added_greding_report_details = $greding_report_details[1];

		return array($form_fields_details,$added_greding_report_details);
