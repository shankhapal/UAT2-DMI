<?php 
	...
	class DmiBgrGradingReturnsTable extends Table{

		var $name = "DmiBgrGradingReturns";
	  ...
	  $DmiBgrGradingReturnsAddMoreDetails = TableRegistry::getTableLocator()->get('DmiBgrGradingReturnsAddMoreDetails');
    $greding_returns_details = $DmiBgrGradingReturnsAddMoreDetails->gredingReturnsDetails();	
	  $added_greding_returns_details = $greding_returns_details[1];

		return array($form_fields_details,$added_greding_returns_details,$sub_commodity_value);
