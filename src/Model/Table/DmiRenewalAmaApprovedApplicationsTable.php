...
class DmiRenewalAmaApprovedApplicationsTable extends Table{
	
	var $name = "DmiRenewalAmaApprovedApplications";

	//this below fucntion is added by AKASH it has been given in the DMI3.9 code . but the DmiRenewalAmaApprovedApplicationsTable isnt have this below function so added.
