<?php 
	...
	class DmiBgrLaboratoryReportTable extends Table{

		var $name = "DmiBgrLaboratoryReport";
	  ...
	  $DmiBgrLaboratoryReportAddMoreDetails = TableRegistry::getTableLocator()->get('DmiBgrLaboratoryReportAddMoreDetails');
    $laboratory_details = $DmiBgrLaboratoryReportAddMoreDetails->labReportDetails();	
	  $added_laboratory_details = $laboratory_details[1];

		return array($form_fields_details,$added_laboratory_details,$sub_commodity_value);
