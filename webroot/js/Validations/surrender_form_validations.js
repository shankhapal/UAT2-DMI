...
function ca_consent_form_validations(){
    ...
    var is_cabook_submitted = $('input[name="is_cabook_submitted"]:checked').val();
    var is_cabook_submitted_docs = $("#is_cabook_submitted_docs").val();
        ...
        if (is_replica_submitted !="" && is_replica_submitted=="yes") {
            ...
            if($('#is_replica_submitted_docs_value').text() == ""){
                ...
                if(check_file_upload_validation(is_replica_submitted_docs).result == false){
                    ...
                    $("#error_is_replica_submitted_docs").show().text(check_file_upload_validation(is_cabook_submitted_docs).error_message);
