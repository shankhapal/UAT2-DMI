...
$(document).ready(function(){
	...
	function add_function(){
		...
		$('#add_const_oils_details').click(function(e) { 
			...
			if(validate_const_oil_details() == true){
				$.ajax({
					type: "POST",
					url: "../AjaxFunctions/addConstOilsDetails",
					data: form_data,  
	...
	function edit_function(){
		...
		$('.edit_const_oils_id').click(function(e) { 
			...
			var form_data = $("#"+form_section_id).serializeArray();
				form_data.push(	{name: "edit_const_oils_id",value: const_oils_id},{name:'cname',value:cname});
			
			$.ajax({
				type: "POST",
				url: "../AjaxFunctions/editConstOilsId",
				data: form_data,  
				beforeSend: function (xhr) { // Add this line
					xhr.setRequestHeader('X-CSRF-Token', $('[name="_csrfToken"]').val());
				}, 
	...
	function delete_function(){
		...
		$('.delete_const_oils_id').click(function(e) { 
			...
			var form_data = $("#"+form_section_id).serializeArray();
				form_data.push(	{name: "delete_const_oils_id",value: const_oils_id},{name:'cname',value:cname});
			
			$.ajax({
				type: "POST",
				url: "../AjaxFunctions/deleteConstOilsId",
				data: form_data,  
				beforeSend: function (xhr) { // Add this line
					xhr.setRequestHeader('X-CSRF-Token', $('[name="_csrfToken"]').val());
				}, 
