...
$("#plz_wait").hide();
    ...
    //taking dynamic final report btn id
    var final_report_btn_id = $('#final_report_btn_id').val();
    ...
    $("#declaration_check_box").change(function() {
        ...
        if ($(this).prop('checked') == true) {
            ...
            var controller_name = $('#controller_name_id').val();
            var report_pdf_function = $('#report_pdf_function_id').val();
        ...
        //applied multiple inner ajax calls
             $.ajax({
                ...
                async: true,
                cache: false,
                url: "../" + controller_name + "/" + report_pdf_function,
