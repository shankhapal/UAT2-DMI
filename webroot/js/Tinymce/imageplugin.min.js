...
!function() {
    ...
    var i, o = tinymce.util.Tools.resolve("tinymce.PluginManager"), v = function() {
    ...
    }, T = e("string"), s = e("object"), c = e("array"), N = t("boolean"), w = t("function"), u = t("number"), m = a(!1), d = a(!(i = null)), g = {
        fold: function(e, t) {
            return e()
        },
        isSome: m,
    ...
    function ie(n, e) {
        var r, t, i = n.dom, a = (f(n.schema.getTextBlockElements(), function(e, t) {
        ...
        t), o = i.getParent(e.parentNode, function(e) {
    ...
    function ae(r, e) {
        var t = function(e) {
            ...
            e.caption) {
                ...
                n.appendChild(Ue.create("figcaption", {
        ...
        Z(i) ? (n = ie(r, i),
        r.selection.select(n)) : r.selection.select(i)
    }
    function oe(t, e) {
        var n, r, i, a, o, l, s, c, u, m, d, g, p, f, h, b = re(t);
        function y() {
            f.onload = f.onerror = null,
            g.selection && (g.selection.select(f),
            g.nodeChanged())
        }
        b ? (n = Y(function(e) {
            return ne(t, e)
        ...
        Z(h.parentNode) ? (d = h.parentNode,
        ie(u, d),
        u.selection.select(h.parentNode)) : (u.selection.select(h),
        g = u,
        p = m,
        (f = h).onload = function() {
        ...
        ,
        f.onerror = y)) : (a = t,
        (o = b) && (l = a.dom.is(o.parentNode, "figure.image") ? o.parentNode : o,
        a.dom.remove(l),
        a.focus(),
        a.nodeChanged(),
        a.dom.isEmpty(a.getBody()) && (a.setContent(""),
        a.selection.setCursorLocation())))) : e.src && ae(t, v(v({}, Q()), e))
    }
    function le(e) {
    ...
    function de(e, t, n, r) {
        ...
        x = U,
        O = C.src.value,
        (/^(?:[a-zA-Z]+:)?\/\//.test(O) ? L.none() : x.prependURL.bind(function(e) {
        ...
        v.hasDimensions && (T(D.width) && (A.dimensions.width = D.width),
        T(D.height) && (A.dimensions.height = D.height)),
        T(D.class) && Ee(v.classList, D.class).each(function(e) {
            A.classes = e.value
        }),
        v.hasImageCaption && N(D.caption) && (A.caption = D.caption),
        v.hasAdvTab && (T(D.style) && (A.style = D.style),
        ...
        (u = s.src.meta || {}).width || u.height || !a.hasDimensions || (0 < c.length ? i.imageSize(c).then(function(e) {
            o.open && l.setData({
                dimensions: e
            })
        }).catch(function(e) {
    ...
    function ge(l, s, t, c) {
        ...
        (0 < (e = n.fileinput).length ? L.some(e[0]) : L.none()).fold(function() {
            c.unblock()
        }, function(n) {
            function r() {
                c.unblock(),
    ...
    function pe(S, U, I) {
        return function(e, t) {
            ...
            "src" === t.name ? de(S, U, I, e) : "images" === t.name ? (c = S,
            u = U,
            m = I,
            g = (d = e).getData(),
            ...
            m.prevImage = p,
            de(c, u, m, d)) : "alt" === t.name ? I.prevAlt = e.getData().alt : "style" === t.name ? (o = S,
            s = (l = e).getData(),
            y = o.parseStyle,
            v = o.serializeStyle,
            D = _(y((A = s).style)),
            (w = xe({}, A)).vspace = D["margin-top"] && D["margin-bottom"] && D["margin-top"] === D["margin-bottom"] ? O(String(D["margin-top"])) : "",
            ...
            w.style = v(y(v(D))),
            l.setData(w)) : "vspace" === t.name || "hspace" === t.name || "border" === t.name || "borderstyle" === t.name ? (n = S,
    ...
    function fe(v) {
        var t, n, r, i, a, o, l, s, c, A = {
            ...
            imageSize: function(e) {
                return R(s, e) ? (i = s.documentBaseURI.toAbsolute(e),
                new De(function(t) {
                    function n(e) {
            ...
            uploadImage: (t = n = r = i = a = o = l = s = c = v,
            function(e) {
    ...
    function he(a) {
        return function(e) {
            for (var t = e.length, n = function(e) {
                ...
                var r, i = e[t];
                (r = i.attr("class")) && /\bimage\b/.test(r) && (i.attr("contenteditable", a ? "false" : null),
    ...
    var ye, ve = be, Ae = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), De = tinymce.util.Tools.resolve("tinymce.util.Promise"), we = tinymce.util.Tools.resolve("tinymce.util.URI"), Se = tinymce.util.Tools.resolve("tinymce.util.XHR"), Ue = Ae.DOM, Ie = function(e, t, n) {
        n ? (Ue.setAttrib(e, "role", "presentation"),
        I(ve(e), "alt", "")) : (i === t ? ve(e).dom.removeAttribute("alt") : I(ve(e), "alt", t),
        "presentation" === Ue.getAttrib(e, "role") && Ue.setAttrib(e, "role", ""))
    }, Ce = function(e, t, n) {
        var r = Y(e, n);
        ee(n, r, t, "caption", function(e, t, n) {
            return H(r = e) ? (o = r.parentNode,
            Ue.insertAfter(r, o),
            Ue.remove(o)) : (i = r,
            a = Ue.create("figure", {
                class: "image"
            ...
            Ue.insertAfter(a, i),
            a.appendChild(i),
            a.appendChild(Ue.create("figcaption", {
                contentEditable: "true"
            }, "Caption")),
        ...
        ee(n, r, t, "class", F),
        ee(n, r, t, "style", te(function(e, t) {
            return F(e, "style", t),
            0
        }, e)),
    ...
    ), Oe = tinymce.util.Tools.resolve("tinymce.util.ImageUploader"), Te = tinymce.util.Tools.resolve("tinymce.util.Tools"), Ne = function(e, a) {
        var o = [];
        return Te.each(e, function(e) {
            var t, n, r, i = T((t = e).text) ? t.text : T(t.title) ? t.title : "";
            void 0 !== e.menu ? (n = Ne(e.menu, a),
            o.push({
                text: i,
                items: n
            })) : (r = a(e),
    ...
    o.add("image", function(e) {
        ...
        (n = e).ui.registry.addToggleButton("image", {
            ...
            onAction: fe(n).open,
            onSetup: function(e) {
                return e.setActive(D(re(n))),
                n.selection.selectorChangedWithUnbind("img:not([data-mce-object],[data-mce-placeholder]),figure.image", e.setActive).unbind
            }
        }),
