...
!function() {
    ...
    function t(r) {
        return function(t) {
            return e = typeof (n = t),
            (null === n ? "null" : "object" == e && (Array.prototype.isPrototypeOf(n) || n.constructor && "Array" === n.constructor.name) ? "array" : "object" == e && (String.prototype.isPrototypeOf(n) || n.constructor && "String" === n.constructor.name) ? "string" : e) === r;
            var n, e
        }
    }
    function n(n) {
    ...
    var u, a = tinymce.util.Tools.resolve("tinymce.PluginManager"), c = tinymce.util.Tools.resolve("tinymce.util.VK"), l = t("string"), d = t("array"), p = function(t) {
        return u === t
    }, f = n("boolean"), s = n("function"), m = i(!1), g = i(!(u = null)), v = {
        fold: function(t, n) {
            return t()
        },
        isSome: m,
    ...
    function M(t, n) {
        if (t.collapsed)
            return [];
        for (var e = t.cloneContents(), r = new dt(e.firstChild,e), o = [], i = e.firstChild; n(i) && o.push(i),
        i = r.next(); )
            ;
        return o
    }
    ...
    function B(t, n) {
        ...
        var r, o = ["noopener"], i = t ? t.split(/\s+/) : [], u = n ? 0 < (r = e(r = i)).length ? r.concat(o) : o : e(i);
        return 0 < u.length ? lt.trim(u.sort().join(" ")) : ""
    }
    function I(t, n) {
        return n = n || t.selection.getNode(),
    ...
    function V(l, c, f) {
        var t, n, e, r, o, i, u, s = l.selection.getNode(), m = I(l, s), g = (n = l,
        e = k(["title", "rel", "class", "target"], function(n, e) {
        ...
        u = st({}, e),
        0 < T(n).length || !1 !== P(n) || (r = B(u.rel, "_blank" === u.target),
        u.rel = r || null),
        ...
        l.undoManager.transact(function() {
            ...
            o.selection.select(i)) : (n = l,
            e = f.text,
            r = g,
            vt(t = s) ? kt(n, t, r) : e.fold(function() {
    ...
    function q(t, n, e) {
        var r, o, i, u, a, l, c, f, s, m, g = (r = t,
        o = e.href,
        st(st({}, e), {
            href: ht.isDomSafe(o, "a", r.settings) ? o : ""
        }));
        t.hasPlugin("rtc", !0) ? t.execCommand("createlink", !1, (a = g.class,
        l = g.href,
        c = g.rel,
        f = g.target,
        s = g.text,
    ...
    function G(d) {
        ...
        Tt(t, n).then(function(t) {
            var n, e, i, u, r = function(t) {
                ...
                t.close()
            }, o = i = d, a = (n = u = t).anchor.text.map(function() {
                return {
                    name: "text",
                    type: "input",
                    label: "Text to display"
                }
            }).toArray(), l = n.flags.titleEnabled ? [{
                name: "title",
                type: "input",
                label: "Title"
            }] : [], c = it.from(N(o)), f = n.anchor, s = {
                url: {
                    value: e = f.url.getOr(""),
                    meta: {
                        original: {
    ...
    function $(t, n) {
        var e, r;
        n && (e = pt(n),
        /^#/.test(e) ? (r = t.$(e)).length && t.selection.scrollIntoView(r[0], !0) : function(t) {
    ...
    var ot = function(e) {
      ...
      , yt = function(t, n) {
        ...
        !r || (e = t.dom.getParents(r, "a[href]", n)[0]) && (e.parentNode.insertBefore(r, e),
        t.dom.remove(e))
    }
      , kt = function(t, n, e) {
        var r, o = t.dom.select("img", n)[0];
        o && (r = t.dom.create("a", e),
      ...
      , bt = function(t, c) {
        function f(t, n) {
            ...
            u = t[o],
            a = 0 < r.length,
            void 0 !== u ? xt(u, i).map(function(t) {
                return {
                    url: {
                        value: t.value,
                        meta: {
        ...
        return {
            onChange: function(t, n) {
                ...
                u.isSome() || a.isSome() ? it.some(st(st({}, u.map(function(t) {
                    return {
                        text: t
                    }
                ...
                }).getOr({}))) : it.none()) : (e = ["anchor", "link"],
                -1 < ut.call(e, l) ? f(t(), n) : ("text" !== l && "title" !== l || (s[l] = t()[l]),
                it.none()))
            }
        }
    }
      ...
      , Tt = function(m, g) {
        return t = (e = m).getParam("link_list"),
        new wt(function(n) {
            l(t) ? Nt.send({
                url: t,
                success: function(t) {
            ...
            return {
                ...
                catalogs: {
                    targets: (f = A(m),
                    d(f) ? ft.sanitize(f).orThunk(function() {
                        return it.some(At)
    ...
    a.add("link", function(t) {
        ...
        (u = t).on("click", function(t) {
            var n = J(u, t.target);
            n && c.metaKeyPressed(t) && (t.preventDefault(),
            $(u, n))
        }),
        u.on("keydown", function(t) {
            var n = X(u);
            n && 13 === t.keyCode && !0 === t.altKey && !1 === t.shiftKey && !1 === t.ctrlKey && !1 === t.metaKey && (t.preventDefault(),
            $(u, n))
        }),
