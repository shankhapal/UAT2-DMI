...
!function() {
    ...
    function le(e, n) {
        return He().browser.isIE() ? (t = e.dom,
        r = n.dom,
        o = Node.DOCUMENT_POSITION_CONTAINED_BY,
        0 != (t.compareDocumentPosition(r) & o)) : (u = e.dom) !== (i = n.dom) && u.contains(i);
        var t, r, o, u, i
    }
    function ae(e, n) {
    ...
    var Re, De = function(e, n) {
        ...
        nu: De,
        detect: function(e, n) {
            var t, r, o = String(n).toLowerCase();
    ...
    C(Me),
    C("Safari"),
    "Windows"), ze = "Android", Le = "Solaris", _e = "FreeBSD", We = "ChromeOS", je = function() {
        return Te({
            current: void 0,
            version: Oe.unknown()
        })
    ...
    }, qe = oe, Ue = Object.keys, Ge = Object.hasOwnProperty, $e = function(e, r) {
        var o = {};
        return ae(e, function(e, n) {
            var t = r(e, n);
            o[t.k] = t.v
    ...
    : tn
      ...
      , Sn = function(e) {
        ...
        if (null == n || null === n.ownerDocument)
            return !1;
        var t, r, o, u, i, c = n.ownerDocument;
        return o = Ve.fromDom(n),
        i = yn(o),
        (hn(u = i) && l(u.dom.host) ? q.some(i) : q.none()).fold(function() {
    ...
    function Bn(e, n, t) {
        if (!(T(t) || o(t) || f(t)))
            throw console.error("Invalid call to Attribute.set. Key ", n, ":: Value ", t, ":: Element ", e),
    ...
    function et(e, n) {
        return t = ["td", "th"],
        (o = void 0 === (o = n) ? v : n)(r = e) ? q.none() : y(t, Ye(r)) ? q.some(r) : On(r, t.join(","), function(e) {
    ...
    function ut(e, t) {
        return O(e, function(e) {
            if ("colgroup" !== Ye(e))
                return ve(e, n = O(nt(e), function(e) {
    ...
    function ht(e) {
        var n, t = me(B(gt(e).rows, function(t, e) {
        ...
        return (n = U.call(t, 0)).sort(void 0),
        n
    }
    function vt(e) {
        var l = {}
    ...
    }, Kt = $t.fromTable, Xt = function(e, n) {
    ...
    function tr(c, l, a) {
        ...
        return ce(c, l) ? q.some({
            ...
            return nr(l).bind(function(u) {
                ...
                if (le(u, i)) {
                    var n, t = 0 < (n = sn(c, "td,th", f(u))).length ? n[n.length - 1] : c;
                    return q.some({
                        boxes: xt(u, c, i, l, u),
                        start: c,
                        finish: t
    ...
    function Dr(e) {
        var n = e.dom.ownerDocument
          ...
          , o = n.documentElement;
        if (t === e.dom)
            return uo(t.offsetLeft, t.offsetTop);
                ...
                return {
                    fold: function() {
                        ...
                        if (e.length !== i.length)
                            throw new Error("Wrong number of arguments to fold. Expected " + i.length + ", got " + e.length);
    ...
    var _r, Wr, jr, Fr = function(n, e, t) {
        return e.bind(function(e) {
            return t.filter(P(n.eq, e))
        })
    }, Hr = function(e, n, t) {
        return 0 < t.length ? (r = e,
        o = n,
        u = t[0],
        I(t.slice(1), function(e, n) {
            var t = o(r, n);
            return Fr(r, e, t)
        }, o(r, u))) : q.none();
        var r, o, u
        ...
        single: ["element"]
    }]), $r = Gr.none, Kr = Gr.multiple, Xr = Gr.single, Yr = tinymce.util.Tools.resolve("tinymce.PluginManager"), Jr = mr("width", function(e) {
        ...
        "border-box" === t ? o : br(n, o, "top", "bottom")) : gr(e, "height", e.dom.offsetHeight);
        var n, t, r, o
    }, oo = function(t, r) {
        return {
            left: t,
        ...
        var n, t = e.dom, r = t.ownerDocument.body;
        return r === t ? uo(r.offsetLeft, r.offsetTop) : Sn(e) ? (n = t.getBoundingClientRect(),
        uo(n.left, n.top)) : uo(0, 0)
    }, co = {
        delta: S,
        ...
        relative: ["%"],
        empty: [""]
    }, so = (jr = ["Infinity", (_r = "[0-9]+") + "\\." + mo(_r) + mo(Wr = "[eE][+-]?[0-9]+"), "\\." + _r + mo(Wr), _r + mo(Wr)].join("|"),
    new RegExp("^([+-]?(?:" + jr + "))(.*)$"));
    function mo(e) {
        return "(?:" + e + ")?"
    }
    ...
    function vo(e) {
        var n, t, r, o, u, i, c, l, a, f, s = ro(e) + "px";
        return s ? (n = s,
        t = e,
        r = Tr,
        o = ho,
    ...
    function ko(e, n, i, c) {
        ...
        return O(t, function(e, u) {
            return Ao(e, u, a, f, function(e) {
                ...
                !Hl(t) || o ? i(e) : Ao(null != (n = l[u]) ? S(n) : q.none(), u, a, f, function(e) {
    ...
    function zo(e, n) {
        ...
        var u, r, i, c, l, a, f, s, o, m, d, g, p = fr(e), b = ct(p), h = Vl(e), v = $t.generate(b), w = (u = t,
        r = v.grid.columns,
        i = v.grid.rows,
        c = r,
        a = l = 0,
        ...
        function(e, n, t, r) {
            for (var o, u, i, c = n.grid.columns, l = n.grid.rows, a = 0; a < l; a++)
                for (var f = !1, s = 0; s < c; s++)
                    a < t.minRow || a > t.maxRow || s < t.minCol || s > t.maxCol || ($t.getAt(n, a, s).filter(r).isNone() ? (o = f,
                    0,
                    u = e[a].element,
                    i = Ve.fromTag("td"),
                    Xt(i, Ve.fromTag("br")),
        ...
        d = v,
        g = function(e, n, t, r) {
            if (0 === r.minCol && n.grid.columns === r.maxCol + 1)
                return 0;
            var o = Bo(n, e, t)
              , u = B(o, function(e, n) {
                return e + n
        ...
        m.minCol !== m.maxCol && m.minRow !== m.maxRow || A(Zn(o, "th,td"), function(e) {
            Wt(e, "rowspan"),
            Wt(e, "colspan")
        }),
        Wt(o, Gt),
    ...
    function Fo(n) {
        return function() {
            ...
            return Xt(e, Ve.fromTag("br", n.dom)),
            e
        }
    }
    function Ho(e) {
    ...
    function Uo(e, n, t) {
        var r, o, u = (It(o = sr(r = e, n), ln(fr(r))),
        o);
    ...
    function $o(a, f, s) {
        ...
        return {
            ...
            row: qo(f),
            cell: function(e) {
                var n, t, r, o, u, i = Ve.fromTag(Ye(e.element), f.dom), c = s.getOr(["strong", "em", "b", "i", "span", "font", "h1", "h2", "h3", "h4", "h5", "h6", "p", "div"]), l = 0 < c.length ? (n = e.element,
                t = i,
                r = c,
                Wo(n).map(function(e) {
                    return I(sn(e, r.join(","), function(e) {
                        ...
                        var t = ar(n);
                        return Wt(t, "contenteditable"),
                        Xt(e, t),
                        t
                    }, t)
                }).getOr(t)) : i;
                return Xt(l, Ve.fromTag("br")),
                m(e, i),
                o = e.element,
                u = i,
                ae(Kl, function(n, t) {
        ...
        a.on("BeforeSetContent", function(l) {
            !0 === l.selection && !0 === l.paste && j(Ql(e)).each(function(c) {
                rt(c).each(function(e) {
                    var n, t, r, o, u = k((n = l.content,
                    (t = document.createElement("div")).innerHTML = n,
                    ln(Ve.fromDom(t))), function(e) {
                        return "meta" !== Ye(e)
                    }), i = en("table");
                    1 === u.length && i(u[0]) && (l.preventDefault(),
    ...
    function au(e, n, t, r, o) {
        var u, i, c, l, a, f, s, m, d, g, p = $t.fromTable(e), b = o.getCellDelta(n), h = o.getWidths(p, o), v = t === p.grid.columns - 1, w = r.clampTableDelta(h, t, b, o.minCellWidth(), v), y = (i = t,
        c = w,
        l = o,
        a = r,
        m = (u = h).slice(0),
        s = i,
        d = 0 === (f = u).length ? ea.none() : 1 === f.length ? ea.only(0) : 0 === s ? ea.left(0, 1) : s === f.length - 1 ? ea.right(s - 1, s) : 0 < s && s < f.length - 1 ? ea.middle(s - 1, s, s + 1) : ea.none(),
        g = C(O(m, C(0))),
        d.fold(g, function(e) {
    ...
    function bu(e, n, t) {
        var r, o, u, i, c = oa.from(t), l = z(e, function(e) {
            return "0px" === e
        }) ? (r = e.length,
        o = c.fold(function() {
            return C("")
    ...
    function wu(l, e, n) {
        var a = $t.fromTable(l)
          ...
          , s = $t.justColumns(a);
        e.each(function(e) {
            var t, r, o, u, n = vu(e), i = vr(l), c = bu(ko(a, l, Do, Io), i, e);
            $t.hasColumns(a) ? (o = c,
            u = n,
            A(s, function(e, n) {
                var t = hu([o[n]], Ft());
    ...
    function Ou(e) {
        ...
        var r, o, u = Ve.fromDom(function(e) {
            if (wn() && l(e.target)) {
    ...
    function Iu(e, n) {
        return o = n,
        Mn(e, t = "class", (void 0 === (r = Pn(e, t)) || "" === r ? [] : r.split(" ")).concat([o]).join(" ")),
        1;
        var t, r, o
    }
    function Bu(e, n) {
    ...
    function Nu(e, n) {
        return void 0 === n && (n = !1),
        !He().browser.isIE() && Sn(e) ? e.dom.isContentEditable : Pu(e).fold(C(n), function(e) {
            return "true" === pa(e)
        })
    }
    function zu(e) {
    ...
    function _u(e, n, t, r, o) {
        var u, i, c, l, a, f = Dr(t), s = n.isResizable, m = 0 < r.length ? co.positions(r, t) : [], d = 0 < m.length ? (u = s,
        ...
        var p, b, h, v, w, y, C, S = 0 < o.length ? ao.positions(o, t) : [], T = 0 < S.length ? (b = s,
        h = [],
    ...
    function bi(p) {
        ...
        var d, g, v = q.none(), w = q.none(), y = q.none();
        return p.on("init", function() {
            var e, n, t, r, o, u, i, c, l, a, m, f, s, d, g = (n = pi,
            (e = p).inline ? (u = Yo(e),
            qn(c = Ve.fromTag("div"), {
                position: "static",
                height: "0",
            ...
            (T(o) ? "table" === o : o) && p.getParam("table_resize_bars", !0, "boolean") && (t = h(),
            l = t,
            a = b,
            m = co,
            f = ao,
            ...
            s.events.adjustHeight.bind(function(e) {
                ...
                var t, r, o, u, i, c, l, a, f, s = m.delta(e.delta, n);
                t = n,
                r = s,
                o = e.row,
                u = m,
                l = $t.fromTable(t),
                a = O(Mo(l, t, u, To, function(e) {
            ...
            r.events.beforeResize.bind(function(e) {
                var n, t = e.table.dom, r = p, o = Jo(n = t), u = Qo(t), i = Pa + e.type;
            ...
            r.events.afterResize.bind(function(e) {
                var n, t, r, o, u, i = e.table, c = i.dom;
                nu(i),
                v.each(function(e) {
                    p.selection.setRng(e),
                    p.focus()
                }),
                n = p,
                r = Jo(t = c),
        ...
        p.on("ObjectResizeStart", function(e) {
            ...
            d = e.width,
            g = Ia(p) ? "" : (o = (t = p).dom.getStyle(r = u, "width") || t.dom.getAttrib(r, "width"),
            q.from(o).filter(ne).getOr("")))
        }),
        p.on("ObjectResized", function(e) {
            var n, t, r, o, u, i, c, l, a, f, s = e.target;
            m(s) && (n = Ve.fromDom(s),
            t = e.origin,
            Ae(t, "corner-") && (r = n,
            o = e.width,
            ...
            au(r, o - d, c, u, i)) : /^(\d+(\.\d+)?)%$/.test(g) && Vn(r, "width", o * parseFloat(g.replace("%", "")) / d + "%"),
            /^(\d+(\.\d+)?)px$/.test(g) && (a = $t.fromTable(l = r),
            $t.hasColumns(a) || A(nt(l), function(e) {
    ...
    function xi() {
        return {
            ...
            transformCell: function(e, n, t) {
                ...
                return we("td" !== Ye(u) ? (o = sr(r = u, "td"),
                Rt(r, o),
                It(o, ln(r)),
                Yt(r),
                o) : u, e.isNew, e.isLocked)
            }
        }
    }
    function Ri() {
    ...
    function ki(u, e) {
        function t(e, n) {
            ...
            It((Bt(o = An(t = u, r = n).getOrThunk(function() {
                ...
                return "thead" === r ? Ai(t, "caption,colgroup", e) : "colgroup" === r ? Ai(t, "caption", e) : Xt(t, e),
                e
            })),
            o), ("colgroup" === n ? function(e) {
                return N(e, function(e) {
                    return O(e.cells, function(e) {
                        return Oi(e.element, "span", e.colspan, 1),
                        e.element
                    })
                })
            }
    ...
    function Bi(m, d) {
        ...
        return O(m, function(e, s) {
            var n = N(e.cells, function(e, n) {
                if (!1 !== g[s][n])
                    return [];
                var t, r, o, u, i, c, l, a, f = (o = n,
                u = d,
                l = (t = m)[r = s],
                a = "colgroup" === l.section,
                {
                    colspan: Ii(l.cells.slice(o), u),
                    rowspan: a ? 1 : Ii((i = t.slice(r),
                    c = o,
                    O(i, function(e) {
                        return st(e, c)
                    })), u)
    ...
    function qi(e, t, i, c) {
        var n, r, l = gt(e).rows;
        return 0 < t && t < l.length && (n = l[t - 1].cells,
        r = i,
        A(B(n, function(e, n) {
    ...
    function Qi(e, u, n, i, c) {
        ...
        }), f = gt(n).rows, s = Ji(a, f, l);
        return function(e, n, t) {
            if (e.row >= n.length || e.column > dt(n[0]))
                return Ga.error("invalid start address out of table bounds, row: " + e.row + ", column: " + e.column);
            var r = n.slice(e.row)
            ...
            return function(e, n, t, r, o, u) {
                for (var i, c, l, a, f, s = e.row, m = e.column, d = s + t.length, g = m + dt(t[0]) + u.length, p = L(u, x), b = s; b < d; b++)
                    for (var h, v, w, y = 0, C = m; C < g; C++)
                        ...
                        f = i[c],
                        1 < i.length && 1 < dt(f) && (0 < l && a(mt(f, l - 1)) || l < f.cells.length - 1 && a(mt(f, l + 1)) || 0 < c && a(mt(i[c - 1], l)) || c < i.length - 1 && a(mt(i[c + 1], l))) && Vi(n, mt(n[b], C), o, r.cell),
    ...
    function ec(e, n, t, r, o) {
        qi(n, e, o, r.cell);
        var u, i, c = ht(n), l = Ui(n, t), a = Yi(n, K(K({}, l), {
            colDelta: l.colDelta - c.length
        }), r), f = gt(a), s = f.cols, m = f.rows, d = ht(a), g = Ui(t, n), p = K(K({}, g), {
    ...
    function nc(e, t, n, r, o) {
        var u, i, c, l, a = gt(e), f = a.rows, s = a.cols, m = f.slice(0, t), d = f.slice(t), g = (u = f[n],
        i = function(e, n) {
    ...
    function tc(e, u, i, c, l) {
        return O(e, function(e) {
            var n, t, r = 0 < u && u < dt(e) && c(mt(e, u - 1), mt(e, u)), o = (n = e.section,
            t = l,
    ...
    function rc(e, n, t, r) {
        return void 0 !== mt((u = e)[i = n], t) && 0 < i && r(mt(u[i - 1], t), mt(u[i], t)) || (o = e[n],
        0 < t && r(mt(o, t - 1), mt(o, t)));
        var o, u, i
    }
    function oc(e, n, t, r) {
        function o(e) {
    ...
    function lc(e, n, t, r, o) {
        var u, i, c, l, a = gt(e).rows, f = N(n, function(e) {
            return cc(a, e, r)
        }), s = O(e, function(e) {
            return yi(e.cells)
        }), m = (u = f,
        z(i = s, S) && yi(u) ? x : function(e, n, t) {
    ...
    function gc(e) {
        return n = e,
        t = Ya.property().name(n),
        y(Xa, t);
        var n, t
    }
    function pc(e) {
        return n = e,
        y(["ol", "ul"], Ya.property().name(n));
        var n
    }
    function bc(e) {
        function u(e) {
    ...
    function yc(e, n, t) {
        ...
        o = t,
        c = gt(e).rows,
        q.from(null === (i = null === (u = c[r]) || void 0 === u ? void 0 : u.cells[o]) || void 0 === i ? void 0 : i.element).filter(hc).orThunk(function() {
    ...
    function Sc(u, i) {
        return function(e, n, t, r, o) {
            return yc(function(e, n, t, r, u, o, i) {
                ...
                var g, p, b, h, v = l.concat(d), w = (g = f,
                z(p = m, S) && yi(g.cells) ? x : function(e, n, t) {
            ...
            return function(t, e, o) {
                ...
                return l(t) ? c(n, t, e, u, i).bind(function(e) {
                    ...
                    e.cursor.fold(function() {
                        ...
                        var n = La(_a, e)
                          , t = m.dom.createRng();
                        return t.setStart(n.element.dom, n.offset),
    ...
    function zc(u, i, c, l, a) {
        ...
        kn(Yo(u), 'table[data-mce-id="__mce"]').map(function(e) {
            var n, t, r;
            return ka(u) ? Ma(e) : Ia(u) ? Ea(e) : (ui(u) || (n = o.width,
            T(n) && -1 !== n.indexOf("%"))) && Ba(e),
            nu(e),
            Wt(e, "data-mce-id"),
            t = u,
    ...
    function Zc(t, r) {
        return function(e) {
            var n;
            t.execCommand("mceTableApplyCellStyle", !1, ((n = {})[r] = e,
            n))
        }
    }
    ...
    function nl(r, e, o) {
        ...
        return [{
            ...
            onAction: function(e) {
                var n, t = "remove" === e.value ? "" : e.value;
                r.execCommand("mceTableApplyCellStyle", !1, ((n = {})[o] = t,
                n))
            }
        }]
    }
    ...
    function ml(e, n, r, t) {
        ...
        e.undoManager.transact(function() {
            var o, u = e, i = n, t = r, c = se(o = l, function(e, n) {
                return t[n] !== e
            });
            0 < ge(c) && 1 <= i.length && rt(i[0]).each(function(e) {
                var s, m, d, n = sl(e, i), t = 0 < ge(se(c, function(e, n) {
                ...
                d = 1 === n.length,
                A(n, function(e) {
                    var n, t, r, o, u, i, c = e.element, l = d ? Nf.normal(s, c) : Nf.ifTruthy(s, c), a = e.column.map(function(e) {
                    ...
                    Zu(s) && ((t = l).setFormat("tablecellbackgroundcolor", (r = m).backgroundcolor),
    ...
    function dl(e, n) {
        var t, l, r, o, u, i = Ql(n);
        0 !== i.length && (l = e,
        t = al(rt((r = i)[0]).map(function(e) {
    ...
    function pl(s, m, d, e) {
        ...
        s.undoManager.transact(function() {
            var e, n, t, i, c, l, a, r = s, o = m, u = d, f = se(e = g, function(e, n) {
                return u[n] !== e
            });
            0 < ge(f) && (n = Ke(f, "type"),
            (t = !n || 1 < ge(f)) && (i = r,
    ...
    function bl(i) {
        var e, t, n, r, o, u, c, l = (e = tu(i),
        t = Xl.selected,
        r = (n = Jl(e)).bind(function(e) {
            return rt(e)
        }).map(ot),
        Wn(n, r, function(n, e) {
            return k(e, function(e) {
    ...
    function hl(u, i, t, e) {
        ...
        u.undoManager.transact(function() {
            var e, n, t, r, o;
            i || (e = parseInt(l.cols, 10) || 1,
            n = parseInt(l.rows, 10) || 1,
            i = zc(u, e, n, 0, 0)),
            0 < ge(a) && (function(e, n, t) {
                var r, o = e.dom, u = {}, i = {};
                if (u.class = t.class,
                i.height = eu(t.height),
                o.getAttrib(n, "width") && !ti(e) ? u.width = (r = t.width) ? r.replace(/px$/, "") : "" : i.width = eu(t.width),
                ti(e) ? (i["border-width"] = eu(t.border),
                i["border-spacing"] = eu(t.cellspacing)) : (u.border = t.border,
                ...
                ni(e) && (i["background-color"] = t.backgroundcolor,
            ...
            u.focus(),
            u.addVisual(),
            0 < ge(a) && (o = !(r = Ke(a, "caption")) || 1 < ge(a),
            Gu(u, i, {
                structure: r,
                style: o
            }))
    ...
    function vl(e, n) {
        var t, r, o, u, i, c, l, a, f, s, m, d, g, p, b, h, v, w, y, C = e.dom, S = (o = ni(r = e),
        a = Qu(r),
        f = Ju(r),
        s = o ? (u = r.dom,
        {
        ...
        K(K({}, i), c))));
        !1 === n ? (t = C.getParent(e.selection.getStart(), "table", e.getBody())) ? (d = t,
        g = ni(m = e),
        v = m.dom,
        w = ti(m) ? v.getStyle(d, "border-spacing") || v.getAttrib(d, "cellspacing") : v.getAttrib(d, "cellspacing") || v.getStyle(d, "border-spacing"),
        y = ti(m) ? Fc(v, d, "padding") || v.getAttrib(d, "cellpadding") : v.getAttrib(d, "cellpadding") || Fc(v, d, "padding"),
        S = K({
            ...
            ti(m) && h.isSome() ? h.getOr("") : p.getAttrib(b, "border") || Fc(m.dom, b, "border-width") || Fc(m.dom, b, "border")),
            caption: !!v.select("caption", d)[0],
            class: v.getAttrib(d, "class", ""),
            align: zf(m, d)
        }, g ? ll(v, d) : {})) : ni(e) && (S.borderstyle = "",
        S.bordercolor = "",
    ...
    function yl(l, n, e, a, t) {
        ...
        function i() {
            return f(function(e, n) {
                ...
                Wi(l = $t.fromTable(e), t).map(function(e) {
                    var r, o, n = e[e.length - 1], t = e[0].column, u = n.column + n.colspan, i = function(e, t, r) {
                        if ($t.hasColumns(e)) {
                            var n = O(k($t.justColumns(e), function(e) {
                                return e.column >= t && e.column < r
                            }), function(e) {
                                var n = fr(e.element);
                                return jc(n, "span", r - t),
                                n
                            })
        ...
        function c(c, e) {
            return e().each(function(e) {
                var i = O(e, fr);
                f(function(e, n) {
                    var t, r, o = Ko(Ve.fromDom(l.getDoc())), u = (t = i,
                    r = o,
                    {
                        selection: ru(a),
                        clipboard: t,
            ...
            mceTableDelete: function() {
                return wl(l).each(function(e) {
                    rt(e, d).filter(p(d)).each(function(e) {
                        ...
                        l.selection.setCursorLocation()) : ((n = l.dom.createRng()).setStart(t.dom, 0),
                        n.setEnd(t.dom, 0),
                ...
                wl(l).each(function(n) {
                    rt(n, d).each(function(r) {
                        An(r, "caption").fold(function() {
                            var e, n, t = Ve.fromTag("caption");
                            Xt(t, Ve.fromText("Caption")),
                            n = t,
                            an(e = r, 0).fold(function() {
                                Xt(e, n)
                            }, function(e) {
                                Rt(e, n)
                            }),
            ...
            mceTableSizingMode: function(e, n) {
                ...
                wl(l).each(function(e) {
                    Ia(l) || ka(l) || ui(l) || rt(e, d).each(function(e) {
                        "relative" !== t || Bl(e) ? "fixed" !== t || Ml(e) ? "responsive" !== t || El(e) || Ea(e) : Ma(e) : Ba(e),
                        nu(e),
                        Gu(l, e.dom, Sa)
                    })
                });
    ...
    function xl(e, n, t) {
        var r, o = e.document.createRange(), u = o;
    ...
    var _l = /(\d+(\.\d+)?)%/
      ...
      , ua = function(e) {
        ...
        return o.slice(0, o.length - 1).concat([(n = o[o.length - 1],
        t = Math.round(r.remainder),
        oa.from(n).fold(C(n), function(e) {
            return e + t + "px"
        }, function(e) {
            return e + t + "%"
        }))])
      ...
      , ga = ca({
        ...
        sink: function(e, n) {
            ...
            }), i = Au(u.element(), "mousedown", e.forceDrop), c = Au(u.element(), "mouseup", e.drop), l = Au(u.element(), "mousemove", e.move), a = Au(u.element(), "mouseout", e.delayDrop);
            return la({
                element: u.element,
                start: function(e) {
                    Xt(e, u.element())
      ...
      , lf = zi(function(e, n, t, r) {
        var o, u, i, c, l = Cc(n), a = (o = l[0].row,
        u = l[l.length - 1].row,
        c = (i = gt(e)).rows,
        i.cols.concat(c.slice(0, o)).concat(c.slice(u + 1))), f = 0 < a.length ? a.length - 1 : 0;
            ...
            return Qc(e) ? {
                ...
                function(t) {
                    function e() {
                        ...
                        var n = Ql(i);
                        o ? (t.setActive(!R(n, e)),
                        r.set(u.formatter.formatChanged(c, function(e) {
                            return t.setActive(!e)
                        }, !0))) : (t.setActive(z(n, e)),
                        r.set(u.formatter.formatChanged(c, t.setActive, !1, {
                            value: l
                        })))
                    }
                    var r = Yc(function(e) {
                      ...
                      , o = !ne(l);
                    return u.initialized ? e() : u.on("init", e),
                    r.clear
                }
                )
            }
      ...
      , Hf = {
        ...
        tablecellborderstyle: K({
            styles: {
                borderStyle: "%value"
            }
        }, Ff),
        tablecellborderwidth: K({
            styles: {
                borderWidth: "%value"
            }
        }, Ff)
    ...
    function Cs(e, n, t, r) {
        return void 0 === r && (r = Ks),
        e.property().parent(n).map(function(e) {
            return ys(e, r)
        })
    }
    function Ss(n) {
    ...
    function Os(e, n, t, r) {
        var o, u, i, c, l, a, f;
        return (Ds(n) ? (o = e,
        (i = r).traverse(u = n).orThunk(function() {
            return pm(u, i.gather, o)
        }).map(i.relative)) : (c = e,
        l = r,
        an(a = n, f = t).filter(Ds).orThunk(function() {
    ...
    function Es(e, n, t) {
        return gn(n) ? Ms(e, n).map(Bs) : pn(n) ? (r = e,
        o = n,
        (0 <= (u = t) && u < Lo(o) ? r.getRangedRect(o, u, o, u + 1) : 0 < u ? r.getRangedRect(o, u - 1, o, u) : q.none()).map(Bs)) : q.none();
        var r, o, u
    }
    function Ps(e, n) {
    ...
    function zs(n, t, e) {
        var r, o = n.move(e, 5), u = vm(t, n, e, o, 100).getOr(o), i = u, c = t;
    ...
    function Us(l) {
        return {
            ...
            getRangedRect: function(e, n, t, r) {
                var o, u, i, c = Yf.exact(e, n, t, r);
                return i = (o = kl(l, c)).getClientRects(),
                0 < (u = 0 < i.length ? i[0] : o.getBoundingClientRect()).width || 0 < u.height ? q.some(u).map(Dl) : q.none()
            },
            ...
            scrollBy: function(e, n) {
                var t, r = e, o = n, u = Ve.fromDom(l.document);
    ...
    : function(o, u, n) {
      ...
      , Zs = function(n, t, e) {
        return e.fold(q.none, q.none, function(e, n) {
            ...
            return n.execCommand("mceTableInsertRowAfter"),
            vs(n, t, e)
        })
    }
      , em = ["table", "li", "dl"]
      ...
      , om = function(t, e, r, n, o) {
        return ce(r, n) ? q.none() : tr(r, n, e).bind(function(e) {
            var n = e.boxes.getOr([]);
            return 1 < n.length ? (o(t, n, e.start, e.finish),
            q.some(nm(q.some(rm(r, 0, r, Lo(r))), !0))) : q.none()
        })
    }
      , um = function(e, n, t, r) {
        void 0 === r && (r = um);
      ...
      , vm = function(t, r, o, u, i) {
        return 0 === i ? q.some(u) : (n = t,
        c = u.left,
        l = r.point(u),
        n.elementFromPoint(c, l).filter(function(e) {
            return "table" === Ye(e)
        }).isSome() ? (e = i - 1,
        vm(t, r, o, r.move(u, 5), e)) : t.situsFromPoint(u.left, r.point(u)).bind(function(e) {
    ...
    function Bm(I, B, e) {
        var M = Xs(Xl, function(l, a, f) {
            e.targets().each(function(c) {
                rt(a).each(function(e) {
                    var n, o, u, t = fi(I), r = $o(E, Ve.fromDom(I.getDoc()), t), i = (n = c,
                    o = r,
        ...
        return I.on("init", function(e) {
            var n, t, r, o, u, i, m, d, g, a, c, l, f, s, p, b, h = I.getWin(), v = Yo(I), w = Zo(I), y = (n = Us(h),
            {
                clearstate: (c = n,
                l = v,
                f = w,
            ...
            }), C = (a = Us(h),
            {
                keydown: function(e, n, t, r, o, i) {
                    ...
                    return rr(m, g.selectedSelector).fold(function() {
                        return qs(c) && !l && g.clearBeforeUpdate(m),
                        Om(c) && l ? P(Fs, a, m, d, xm, r, n, g.selectRange) : Dm(c) && l ? P(Fs, a, m, d, Rm, r, n, g.selectRange) : Om(c) ? P(_s, a, d, xm, r, n, js) : Dm(c) ? P(_s, a, d, Rm, r, n, Ws) : q.none
                    }, function(u) {
                        function e(e) {
                            return function() {
                                return H(e, function(e) {
                                    ...
                                    t = e.cols,
                                    r = m,
                                    ur(u, n, t, (o = g).firstSelectedSelector, o.lastSelectedSelector).map(function(e) {
                                    ...
                                    return or(m, g.firstSelectedSelector, g.lastSelectedSelector).map(function(e) {
                                        ...
                                        return a.setRelativeSelection(Kf.on(e.first, 0), n(e.table)),
                                        g.clear(m),
                                        nm(q.none(), !0)
                                    })
                                }, function(e) {
                ...
                keyup: function(c, l, a, f, s) {
                    return rr(m, g.selectedSelector).fold(function() {
                        var t, r, e, o, u, n = c.raw, i = n.which;
                        return !0 === n.shiftKey && qs(i) ? (t = m,
                        r = d,
                        u = g.selectRange,
                        ce(e = l, o = f) && a === s ? q.none() : In(e, "td,th", r).bind(function(n) {
                ...
                p.on(function(e) {
                    ...
                    Hs(i.target, f).each(function(u) {
                        tr(e, u, f).each(function(e) {
                            var n, t, r, o = e.boxes.getOr([]);
                            1 === o.length ? (n = o[0],
                            t = "false" === pa(n),
                            r = Ln(Pu(i.target), n, ce),
                            t && r && (s.selectRange(l, o, n, n),
                            c.selectContents(n))) : 1 < o.length && (s.selectRange(l, o, e.start, e.finish),
                            c.selectContents(u))
                        })
                    })
                })
            ...
            function R(e, n) {
                !0 === e.raw.shiftKey && (n.kill && e.kill(),
            ...
            var O, A, k = (O = Xc(Ve.fromDom(v)),
            A = Xc(0),
            {
                touchEnd: function(e) {
                    var n, t, r = Ve.fromDom(e.target);
                    "td" !== Ye(r) && "th" !== Ye(r) || (n = O.get(),
                    t = A.get(),
                    ce(n, r) && e.timeStamp - t < 300 && (e.preventDefault(),
                    S(r, r))),
                    O.set(r),
                    A.set(e.timeStamp)
                }
            ...
            I.on("keyup", function(e) {
                var n, t, r, o = ma(e);
                o.raw.shiftKey && qs(o.raw.which) && (n = I.selection.getRng(),
            ...
            return rt(r.element).map(function(e) {
                var t = $t.fromTable(e)
                  , n = B(_i(t, r).getOr([]), function(e, n) {
                    return n.isLocked && (e.onAny = !0,
                    0 === n.column ? e.onFirst = !0 : n.column + n.colspan >= t.grid.columns && (e.onLast = !0)),
                    e
                }, {
                    onAny: !1,
                    onFirst: !1,
    ...
    Yr.add("table", function(c) {
        var e, n, t, r, o, u, i, l, a, f, s, m, d = (e = function() {
            return Yo(c)
        }
        ,
        n = function() {
        ...
        }), g = Mm(c, d), p = bi(c), b = Bm(c, p.lazyResize, g), h = Ec(c, b, p.lazyWire), v = (r = Jc(),
        o = Jc(),
        {
            getRows: r.get,
            setRows: function(e) {
                e.fold(r.clear, r.set),
                o.clear()
            },
            clearRows: r.clear,
            getColumns: o.get,
            setColumns: function(e) {
                e.fold(o.clear, o.set),
                r.clear()
            },
        ...
        0 < (l = (i = c).getParam("table_toolbar", "tableprops tabledelete | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol")).length && i.ui.registry.addContextToolbar("table", {
