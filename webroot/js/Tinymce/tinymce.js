...
!function() {
    ...
    function to(i) {
        ...
        var t, s, n, r, o, a, u, c, S = {}, l = {}, E = [], f = {}, d = {}, m = (t = (i = i || {}).schema,
        c = {},
        ...
        function O(e) {
            var t, n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)])?$/, C = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/, x = /[*?+]/;
            if (e) {
                var w = Zr(e, ",");
    ...
    function ro(b, e) {
        var u, o, y = this, C = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi, x = /(?:url(?:(?:\(\s*\"([^\"]+)\"\s*\))|(?:\(\s*\'([^\']+)\'\s*\))|(?:\(\s*([^)\s]+)\s*\))))|(?:\'([^\']+)\')|(?:\"([^\"]+)\")/gi, w = /\s*([^:]+):\s*([^;]+);?/g, S = /\s+$/, E = {}, N = bo;
        b = b || {},
            ...
            parse: function(e) {
                ...
                if (e) {
                    for (e = (e = e.replace(/[\u0000-\u001F]/g, "")).replace(/\\[\"\';:\uFEFF]/g, r).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(e) {
                        ...
                        c && l && (c = i(c),
                        l = i(l),
                        -1 === c.indexOf(N) && -1 === c.indexOf('"') && (b.allow_script_urls || "behavior" !== c && !/expression\s*\(|\/\*|\*\//.test(l)) && ("font-weight" === c && "700" === l ? l = "bold" : "color" !== c && "background-color" !== c || (l = l.toLowerCase()),
    ...
    ui.prototype.fire = function(e, t, n) {
        ...
        for (var o = so({
            type: t,
            target: e
        }, n); (r = e[this.expando]) && this.executeHandlers(o, r),
    ...
    var ci, li, fi, di, mi, gi, pi, hi, vi, bi, yi, Ci, xi, wi, Si, Ei, Ni, ki = "sizzle" + -new Date, _i = window.document, Ai = 0, Ri = 0, Di = ua(), Ti = ua(), Oi = ua(), Bi = function(e, t) {
        return e === t && (bi = !0),
        0
    }, Pi = "undefined", Li = {}.hasOwnProperty, Ii = [], Mi = Ii.pop, Fi = Ii.push, Ui = Ii.push, zi = Ii.slice, Hi = Ii.indexOf || function(e) {
        for (var t = 0, n = this.length; t < n; t++)
            if (this[t] === e)
                return t;
        return -1
    }
    , ji = "[\\x20\\t\\r\\n\\f]", Vi = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", qi = "\\[" + ji + "*(" + Vi + ")(?:" + ji + "*([*^$|!~]?=)" + ji + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + Vi + "))|)" + ji + "*\\]", $i = ":(" + Vi + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + qi + ")*)|.*)\\)|)", Wi = new RegExp("^" + ji + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ji + "+$","g"), Ki = new RegExp("^" + ji + "*," + ji + "*"), Xi = new RegExp("^" + ji + "*([>+~]|" + ji + ")" + ji + "*"), Yi = new RegExp("=" + ji + "*([^\\]'\"]*?)" + ji + "*\\]","g"), Gi = new RegExp($i), Ji = new RegExp("^" + Vi + "$"), Qi = {
        ID: new RegExp("^#(" + Vi + ")"),
        CLASS: new RegExp("^\\.(" + Vi + ")"),
        TAG: new RegExp("^(" + Vi + "|[*])"),
        ATTR: new RegExp("^" + qi),
    ...
    }, Zi = /^(?:input|select|textarea|button)$/i, ea = /^h\d$/i, ta = /^[^{]+\{\s*\[native \w/, na = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ra = /[+~]/, oa = /'|\\/g, ia = new RegExp("\\\\([\\da-f]{1,6}" + ji + "?|(" + ji + ")|.)","ig");
    try {
                ...
                : function(e, t, n) {
                    ...
                    if (l) {
                        ...
                        v && d) {
                            ...
                            for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((b ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[ki] || (i[ki] = {}))[m] = [Ai, a]),
                            i !== e)); )
                                ;
    ...
    gi = aa.compile = function(e, t) {
                                    ...
                                    sa(function(e, t, n, r) {
                                        var o, i, a, u = [], s = [], c = t.length, l = e || function(e, t, n) {
                                            for (var r = 0, o = t.length; r < o; r++)
                                                aa(e, t[r], n);
                                            return n
                                        }(g || "*", n.nodeType ? [n] : n, []), f = !m || !e && g ? l : ha(l, u, m, n, r), d = p ? v || (e ? m : c || h) ? [] : t : f;
                                        if (p && p(f, d, n, r),
                                        h)
                                            for (o = ha(d, s),
                                            h(o, [], n, r),
        ...
        function a(e, t, n, r, o) {
            var i, a, u, s = 0, c = "0", l = e && [], f = [], d = hi, m = e || y && li.find.TAG("*", o), g = Ai += null == d ? 1 : Math.random() || .1, p = m.length;
    ...
    pi = aa.select = function(e, t, n, r) {
        ...
        1 === l.length) {
            ...
            for (o = Qi.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o],
            !li.relative[u = a.type]); )
    ...
    var Wa = wa
      ...
      , Ja = function(a, u) {
        ...
        void 0 === u && (u = {});
        var _, A, R, D, e, t, T = {}, O = window, B = {}, P = 0, L = Ar.forElement(Nt.fromDom(a), {
            contentCssCors: u.contentCssCors,
            referrerPolicy: u.referrerPolicy
        }), I = [], M = u.schema || to({}), F = ro({
            url_converter: u.url_converter,
            url_converter_scope: u.url_converter_scope
        }, u.schema), U = u.ownEvents ? new ai : ai.Event, z = M.getBlockElements(), H = Wa.overrideDefaults(function() {
            return {
                context: a,
                element: $.getRoot()
            }
    ...
    function js(e, t, n) {
        var r, o, i, a = _u(t.getBoundingClientRect(), n), u = "BODY" === e.tagName ? (r = e.ownerDocument.documentElement,
    ...
    var ic, ac, uc = jn, sc = sn, cc = Ja.nodeIndex, lc = function(e) {
        ...
        return yc(e) || Cc(e)
    }, Sc = Yn, Ec = Jn, Nc = an("display", "block table table-cell table-caption list-item"), kc = Ir, _c = Pr, Ac = zn, Rc = jr, Dc = A(Js, !0), Tc = A(Js, !1);
    function Oc(e, t) {
    ...
    function Cf(r, l) {
        ...
        var p, h, v, b, y, C, x, w, S, E, N, k, _, A, R, D = "data-mce-selected", T = l.dom, O = Et.each, B = l.getDoc(), P = document, L = Math.abs, I = Math.round, M = l.getBody(), F = {
            nw: [0, 0, -1, -1],
            ne: [1, 0, 1, -1],
            se: [1, 1, 1, 1],
            sw: [0, 1, -1, 1]
    ...
    function Af(e, t, n, r) {
        var o, i = e.getRoot(), a = !1, u = r[(n ? "start" : "end") + "Container"], s = r[(n ? "start" : "end") + "Offset"], c = zn(u) && s === u.childNodes.length, l = e.schema.getNonEmptyElements(), f = n;
        if (Ir(u))
            return ve.none();
    ...
    function Xf(e, t, n, r) {
        ...
        Fn(l.left + c.left + u.left, l.top + c.top + u.top)), d = tn(window);
    ...
    Xd.isDomSafe = function(e, t, n) {
        ...
        i = t,
        !(r = n).allow_html_data_urls && (/^data:image\//i.test(o) ? (V(a = r.allow_svg_data_urls) ? !a : !V(i) || !D(Wd, i)) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))))
    }
    ,
    ...
    function Hm(e, t) {
        ...
        o = (n = t).container(),
        i = n.offset(),
        !1 === as.isTextPosition(n) && o === r.parentNode && i > as.before(r).offset() ? as(t.container(), t.offset() - 1) : t;
        var n, r, o, i
    }
    function jm(e) {
    ...
    function Ym(t, n, e, r) {
        ...
        h = t.getBody(),
        v = e.dom,
        (p ? $m : qm)(h, v).map(A(Hm, v))), y = gr(e, A(Km, t), (o = t.getBody(),
        function(e) {
            return e.dom === o
        }
        )), C = (u = b,
    ...
    function ng(e, t, n, r) {
        ...
        var i, a, u = Qm(n.startContainer, r), s = Qm(n.endContainer, r), c = u.bind((a = r,
        function(t) {
    ...
    function ag(e, t) {
        ...
        ), y = dn(Qm((r = t).startContainer, o = b), Qm(r.endContainer, o), Jm), C = (l = b,
    ...
    function lg(s, c, e) {
        ...
        return ug(e.bind(function(e) {
            var t, n, r, o = e.rng, i = e.isStartInTable, a = (t = i ? o.endContainer : o.startContainer,
    ...
    function wg(e, o, i, t) {
        ...
        a), R = Cg(o, i.startContainer), D = yg(U(A.firstChild.childNodes, function(e) {
    ...
    function Sg(e, t, n) {
        ...
        if (m.isDefaultPrevented())
            ...
            t = t.replace(/\{\$caret\}/, d);
            var g, p, h = (g = u.getRng()).startContainer || (g.parentElement ? g.parentElement() : null), v = e.getBody();
            ...
            O.invalid) {
                ...
                w = C.lastChild,
                !x || x === w && "BR" === x.nodeName ? b.dom.setHTML(C, y) : b.selection.setContent(y));
            E = l,
    ...
    function Ng(e, t, n) {
        ...
        !0 !== n && vd(r = e) && ef(r.getBody()).each(function(e) {
            var t = e.getNode()
    ...
    function jg(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y = e.dom, C = e.selection, x = [], w = C.getRng(), S = w.startContainer, E = w.startOffset, N = S;
    ...
    var qg, $g = ["font", "text-decoration", "text-emphasis"], Wg = A(sm, !0, Gc), Kg = A(sm, !1, Gc), Xg = lm(!0, fm), Yg = lm(!1, fm), Gg = lm(!0, Jn), Jg = lm(!1, Jn), Qg = lm(!0, cn), Zg = lm(!1, cn), ep = lm(!0, dm), tp = lm(!1, dm), np = A(Cm, !1), rp = A(Cm, !0), op = A(ym, !1), ip = A(ym, !0), ap = A(wm, !1), up = A(wm, !0), sp = or([{
    ...
    function Rp(e, t, n) {
        ...
        return zn(o) && (r = o.childNodes.length - 1,
        !n && i && i--,
      ...
      , Rh = function(S, E, N, r) {
        ...
        function g(e, t) {
            ...
            return Ah(e, function(e) {
                return !!fl(e) && (V(e.collapsed) && e.collapsed !== a || !u.is(t, e.selector) || zc(t) ? void 0 : (k(t, e),
                !(n = !0)))
            }),
            n
        }
        function o(x, e, l) {
            ...
            Y(w, function(e) {
                ...
                t = x,
                o = e,
                !dl(r = A) || "sub" !== r.inline && "sup" !== r.inline || (wh(o, kp(t, "fontSize"), _p(t, "fontSize", "")),
                t.remove(t.select("sup" === r.inline ? "sub" : "sup", o), !0)),
                Np(x, A, 0, e)) : x.remove(e, !0)
            })
        }
        var e, t, n, i, _ = S.formatter.get(E), A = _[0], a = !r && S.selection.isCollapsed(), u = S.dom, s = S.selection;
        if ("false" !== u.getContentEditable(s.getNode()))
            ...
            o(u, Sl(S, e, _), !0)) : o(u, r, !0) : a && dl(A) && !_l(S).length ? function(e, t, n) {
                var r, o = e.selection, i = o.getRng(), a = i.startOffset, u = i.startContainer.nodeValue, s = Hc(e.getBody(), o.getStart());
                s && (r = Lg(s));
                var c, l, f, d, m = /[^\s\u00a0\u00ad\u200b\ufeff]/;
    ...
    function qh(e, p) {
        ...
        p.remove_trailing_brs && e.addNodeFilter("br", function(e, t, n) {
            var r, o, i, a, u, s, c, l, f = e.length, d = Et.extend({}, h.getBlockElements()), m = h.getNonEmptyElements(), g = h.getWhiteSpaceElements();
            for (d.body = 1,
            r = 0; r < f; r++)
                if (i = (o = e[r]).parent,
    ...
    function Kh(L, I) {
        ...
        }),
        {
            ...
            serialize: function(e, t) {
                ...
                r.selection || vo(Nt.fromDom(n)) ? o : Et.trim(o)), B = (i = U,
                a = O,
                s = (u = T).selection ? _e({
                    forced_root_block: !1
                }, u) : u,
                c = i.parse(a, s),
                !P(f = c.lastChild) || P(l = f.prev) && (f.remove(),
                l.remove()),
                c);
                function P(e) {
                    return e && "br" === e.name
    ...
    function tv(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d = Qh(n.forced_plugins), m = Qh(r.plugins), g = Zh(o = t, "mobile") ? o.sections().mobile : {}, p = g.plugins ? Qh(g.plugins) : m, h = (i = (u = t,
        s = m,
        c = p,
        (a = e) && (0,
        f = (l = u).sections(),
        Zh(l, "mobile") && "mobile" === f.mobile.theme) ? U(c, A(D, Nv)) : a && Zh(u, "mobile") ? c : s),
    ...
    function av(e, t, n) {
        var r, o, i, a, u, s, c = Nt.fromDom(e.getBody()), l = e.inline ? c : Nt.fromDom(Dt(c).dom.documentElement), f = (r = e.inline,
        i = t,
        a = n,
    ...
    function uv(o) {
        ...
        function t(n, e) {
            if (void 0 === e && (e = !0),
            !o.removed && (r = (t = o).inline ? t.getBody() : t.getContentAreaContainer(),
    ...
    }), Av = A(ov, "clientWidth"), Rv = A(ov, "clientHeight"), Dv = A(iv, "margin-top"), Tv = A(iv, "margin-left"), Ov = su.PluginManager, Bv = su.ThemeManager;
    function Pv(r) {
        function o() {
            var e = r.theme;
    ...
    function Kv(l) {
        ...
        var u, s, c, d, m = Vv(), g = Hv(), p = [], h = (d = ru(null),
    ...
    function Xv(e, t) {
        ...
        var n, o, r, g = t && t.schema || to({}), p = function(n, e, t) {
            ...
            !(!(c = (s = g.getElementRule(u)) && s.parentsRequired) || !c.length) && (a && -1 !== Et.inArray(c, a) ? a : c[0]));
            if (d)
                f === d ? (o = e[0],
                e = e.slice(1)) : o = d;
            else if (l)
    ...
    function Gv(n, e) {
        var r, t, o = "", i = (t = n.getParam("preview_styles", "font-family font-size font-weight font-style text-decoration text-transform color background-color border border-radius outline text-shadow"),
        X(t) ? t : "");
        if ("" === i)
            return "";
        function a(e) {
        ...
        var s, c = e.block || e.inline || "span", l = (s = e.selector) && "string" == typeof s ? (s = (s = s.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"),
        Et.map(s.split(/(?:>|\s+(?![^\[\]]+\]))/), function(e) {
            var t = Et.map(e.split(/(?:~\+|~|\+)/), Yv)
              , n = t.pop();
            return t.length && (n.siblings = t),
            n
        }).reverse()) : [], f = l.length ? (l[0].name || (l[0].name = c),
        c = e.selector,
        Xv(l, n)) : Xv([c], n), d = dy.select(c, f)[0] || f.firstChild;
    ...
    function vb(t, n) {
        var e, r, o, i, a, u, s, c = Nt.fromDom(t.getBody()), l = (e = c.dom,
        r = n,
    ...
    function yb(e) {
        ...
        !bb(u = i, (s = a).startContainer) && !bb(u, s.endContainer) && c && l ? ((t = e).setContent(""),
    ...
    }, ly = 0, fy = Et.each, dy = Ja.DOM, my = [9, 27, Bf.HOME, Bf.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, Bf.DOWN, Bf.UP, Bf.LEFT, Bf.RIGHT].concat(xt.browser.isFirefox() ? [224] : []), gy = "data-mce-placeholder", py = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/, hy = A(ob, !0), vy = A(ob, !1), by = Xn, yy = Yn, Cy = or([{
        remove: ["element"]
    }, {
        moveToElement: ["element"]
    }, {
        moveToPosition: ["position"]
    }]), xy = jn, wy = A(Ub, !0), Sy = A(Ub, !1), Ey = or([{
        before: ["element"]
    }, {
        start: ["element"]
    }, {
    ...
    function Zy(t, e, n, r, o, i) {
        ...
        if (c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : Ou(n)) {
            var p = function(e, t, n, r) {
                ...
                var i, a, u, s = Pc(t), c = [], l = 0, f = 1 === e ? (i = s.next,
                a = Du,
                u = Ru,
                as.after(r)) : (i = s.prev,
                a = Ru,
    ...
    function i0(e, t, n) {
        ...
        !!y(o.selection.getSel().modify) && (r && Fr(a) ? ky(!0, o.selection, a) : !(r || !Ur(a)) && ky(!1, o.selection, a)));
        var r, o, i, a
    }
    function a0(g) {
        var p = ru(null)
                ...
                return dn(f, e, function() {
                    ...
                    return e.bind(function(e) {
                        return t.map(function(e) {
                            return a ? c0(i, o, u, e) : c0(i, o, e, u),
                            !0
                        })
                    })
                }).getOr(!1)
    ...
    function d0(g, p) {
        var t, e = Nt.fromDom(g.getBody()), n = Nt.fromDom(g.selection.getStart()), h = U(z(t = hm(n, e), lo).fold(J(t), function(e) {
            return t.slice(0, e)
        }), f0);
    ...
    function N0(e) {
        var t, n, r, o = e.dom, i = e.selection, a = e.schema, u = a.getBlockElements(), s = i.getStart(), c = e.getBody(), l = Ss(e);
        if (s && zn(s) && l) {
    ...
    function $0(u, s, c) {
        var e, t, n = (e = !!s,
        t = c.getNode(e),
        zn(t) && "TABLE" === t.nodeName ? ve.some(t) : ve.none()), r = !1 === s;
        n.fold(function() {
    ...
    function sC(a, e) {
        function t(e) {
            var t, n = m, r = l.getTextInlineElements(), o = e || "TABLE" === C || "HR" === C ? c.create(e || p) : b.cloneNode(!1), i = o;
        ...
        F && ((p && !h || !p && h) && (m = function(e, t, n, r) {
            ...
            if (!m || !oC(f, m)) {
                if (s = ((m = m || d) === e.getBody() || (c = m) && /^(TD|TH|CAPTION)$/.test(c.nodeName) ? m : m.parentNode).nodeName.toLowerCase(),
                !m.hasChildNodes())
    ...
    var LC = A(zy, Py.Up, Ru, Du)
      ...
      , XC = function(e, t) {
        return n = as.after(t),
        !!Wn(n.getNode()) || Ql(e, as.after(t)).map(function(e) {
            return Wn(e.getNode())
        }).getOr(!1);
        var n
    }
                ...
                t = {
                    ...
                    (m = {
                        pageX: (b = function(e, t) {
                            ...
                            var n, r, o, i, a, u = r1(e.getContentAreaContainer()), s = (r = (n = e).getBody(),
    ...
    function a1(e) {
        ...
        var r, o, i, s, u, c, a = cu(), l = Ja.DOM, f = document, d = i1(u = a, c = e), m = (r = i = a,
        function() {
            r.on(function(e) {
    ...
    function c1(l) {
        ...
        l.on("mousedown", function(e) {
            ...
            a = y.getParent(r, C),
            u = y.getParent(o, C),
            !K(a) && (r !== u && y.isChildOf(a, u) && !1 === P1(s1(l, a)) || !y.isChildOf(u, a) && (i = u,
    ...
    function v1(t, e) {
        ...
        mh(t) || (s = t).on("click", function(e) {
            ...
            o = as.fromRangeStart(r),
            i = as.fromRangeEnd(r),
            !as.isElementPosition(o) || n1(n = o.container()) && ef(n).each(function(e) {
    ...
    function b1(e, t) {
        var n, r, o, i, a = e.translate("Rich Text Area"), u = (n = e.id,
        r = a,
        t.height,
    ...
    function N1(c, l) {
        var e, t, f = tu.ScriptLoader, n = f, r = l, o = function() {
            ...
            !1 === uu.hasCode(u) && "en" !== u && (a = "" !== s ? s : i.editorManager.baseURL + "/langs/" + u + ".js",
    ...
    var Tx, Ox = Ja.DOM, Bx = Et.explode, Px = Et.each, Lx = Et.extend, Ix = 0, Mx = !1, Fx = [], Ux = [], zx = "CSS1Compat" !== document.compatMode, Hx = _e(_e({}, fx), {
        baseURI: null,
        baseURL: null,
        defaultSettings: {},
        ...
        init: function(r) {
            ...
            var n, c = this, l = Et.makeMap("area base basefont br col frame hr img input isindex link meta param embed source wbr track colgroup option table tbody tfoot thead tr th td script noscript style textarea video audio iframe object menu", " "), f = function(e) {
                n = e
            }, t = function() {
                function n(e, t, n) {
                    var r = new kx(e,t,c);
                ...
                r.types ? Px(r.types, function(t) {
                    Et.each(o, function(e) {
                        return !Ox.is(e, t.selector) || (n(u(e), Lx({}, r, t), e),
                        !1)
                    })
                }) : (Et.each(o, function(e) {
                    var t;
        ...
        execCommand: function(e, t, n) {
            ...
            switch (e) {
            case "mceAddEditor":
                return this.get(n) || new kx(n,this.settings,this).render(),
                !0;
            case "mceRemoveEditor":
                return r && r.remove(),
                !0;
            case "mceToggleEditor":
                return r ? r.isHidden() ? r.show() : r.hide() : this.execCommand("mceAddEditor", !1, n),
                !0
            }
...
!function() {
    ...
    var M, b = function(r) {
        ...
        return null == n ? f : b(n)
    }, x = g("object"), A = g("array"), _ = (M = void 0,
    function(n) {
        return M === n
    }
    ), D = Array.prototype.indexOf, P = Array.prototype.push, U = Object.prototype.hasOwnProperty, N = v(function(n, t) {
