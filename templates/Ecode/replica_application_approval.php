<?php ?>
<?php echo $this->Html->css('Ecode/replica_application_approval'); ?>
<?php echo $this->Form->create(null, array('type'=>'file', 'enctype'=>'multipart/form-data', 'id'=>'firm_form')); ?>
	<section class="content form-middle form_outer_class" id="form_outer_main">
		<a href="../Ecode/replica_appl_list" class="btn btn-primary">Back</a>
			<div class="container-fluid form-group wd1080">
	  			<h5 class="mt-1 mb-2">E-Code Replica Application</h5>
					<div class="row">
						<div class="col-md-12">
							<div id="firm_details_block" class="card card-success">
								<div class="card-header"><h3 class="card-title">Firm Details</h3></div>
									<div class="form-horizontal">
										...
										<div class="col-md-3">
											<?php echo $this->form->control('e_code', array('type'=>'text', 'id'=>'e_code','value'=>$firm_details['e_code'], 'class'=>'form-control', 'readonly'=>true, 'label'=>'Granted E-Code No.')); ?>
										</div>
	...
	<?php echo $this->Html->script('Ecode/replica_serial_approval'); ?>
