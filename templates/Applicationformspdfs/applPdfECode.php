...
<style>
	...
	<table width="100%" border="1">
		...
		<td align="center" style="padding:5px;">		
			<h4>Application for Grant & Issue of E-Code</h4>
		</td>
		</tr>
	</table>
	...
	<table  width="100%">
		...
		<tr>
			<td><br>I/We <?php echo $customer_firm_data['firm_name']; ?> of M/s <?php echo $customer_firm_data['street_address'].', '; echo $firm_district_name.', '; echo $firm_state_name.', '; echo $customer_firm_data['postal_code']; ?> being desirous of marking <?php echo $sub_commodities_list;?> with a grade designation mark in accordance with the rules made under the provisions of Agricultural Produce (Grading & Marking) Act, 1937, hereby, request for grant of Certificate and issue E-Code.</td>
		</tr>
