...
<?php 
	echo $this->Form->control('application_mode', array('type'=>'hidden', 'id'=>'application_mode', 'value'=>$_SESSION['application_mode'],'label'=>false,));
	echo $this->Html->script('misgrading/mmr_communication');
?>
