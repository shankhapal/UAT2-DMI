				...
				<div class="row">
					<div class="col-md-12">
						<div class="card card-cyan">
							<div class="card-header"><h4 class="card-title-new">Add Page</h4></div>
								<div class="form-horizontal">
									<div class="card-body">
										<?php echo $this->Form->create(null,array('class'=>'form-group','id'=>'add_page')); ?>
										...
										<div class="card-footer cardFooterBackground">
											<?php echo $this->Form->submit('Publish', array('name'=>'publish', 'id'=>'publish_btn','label'=>false,'class'=>'float-left btn btn-primary')); ?>
