									...
									<tbody>
										...
										<?php } else { ?>
											...
											foreach($datalist as $eachdata){ 
												...
												$femail = $eachdata['email'];
												?>
												<tr>
													<td><?php echo 	$sr_no;?></td>
													<td><?php echo 	$eachdata['customer_id']; ?></td>
													<td><?php echo  $eachdata['firm_name']; ?></td>
													<td><?php echo  $eachdata['district_name']; ?></td>
													<td><?php echo  $eachdata['modified']; ?></td>
													<td><?php echo $this->Html->link('Edit', array('controller' => 'othermodules', 'action'=>'fetch_firm_id', $eachdata['id']),array('class'=>'btn btn-primary')); ?>
												</tr>
											<?php $sr_no++;  } 
										} ?>
									</tbody>
