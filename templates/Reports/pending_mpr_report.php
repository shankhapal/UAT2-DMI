...
<div class="content-wrapper">
	<div class="content-header page-header" id="page-load">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
  					<?php if($report_name == 'AQCMS Pendency MPR') { ?>
							...
							<div id="search_by_options" class="">
								...
								<div class="row report-filter pending_report-filter">
									...
									<!-- <div class="col-sm-3" id="office_ama">
										<div class="form-group">
											<label>Month</label>
											<?php //echo $this->form->input('from_date', array('type'=>'month', 'value'=>'','label'=>false, 'id'=>'month', 'empty'=>'select', 'escape'=>false, 'class'=>'form-control form-control-sm search_field', 'placeholder'=>'Month','min'=>'2023-30', 'value'=>'2023-30')); ?>
										</div>
									</div> -->
									<!-- <div class="col-sm-3" id="office_ama">
										<div class="form-group">
							...
							<table class="table table-sm rounded" id="pending-new-applications-report-data-table">
								<thead class="table-light">
									<tr class="rounded">
										...
										<!-- <th><span class="table-heading">Reason For Delay</span></th>
										<th><span class="table-heading">Action Taken For Completion/Disposal of Pending Application</span></th> -->
									</tr>
								</thead>
								<tbody class="">
									...
									<tr id="table_row" class="row-hover border border-light">
										...
										<!-- <td>
										<span class="badge subtitle borderless"></span>
										</td> -->
