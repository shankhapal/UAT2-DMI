<?php echo $this->Html->css('Replica/replica_alloted_list_element') ?>
<?php echo $this->Form->create(); ?>
    <div class="replica_details_mod form-group">
        ...
        <button id="replica_details_btn" class="btn btn-primary">Get Replica Details</button>
    ...
    <div class="card card-info">
        <div class="card-header"><h3 class="card-title-new">Alloted Replica Status</h3></div>
...
<?php echo $this->Html->script('replica/replica_alloted_list_element'); ?>
