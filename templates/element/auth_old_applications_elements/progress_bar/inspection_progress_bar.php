...
?>
	...
	<div class="progress">
		<a href="<?php echo $this->request->getAttribute('webroot');?>oldappinspections/edit_firm_profile">
		...
		<a href="<?php echo $this->request->getAttribute('webroot');?>oldappinspections/edit_premises_profile">
		...
		<a href="<?php echo $this->request->getAttribute('webroot');?>oldappinspections/edit_machinery_profile">
			<div id="machinery_profile" class="progress-bar progress-bar-danger wd14" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" >
		...
		<?php if ($ca_bevo_applicant == 'no') { ?>
			<a href="<?php echo $this->request->getAttribute('webroot');?>oldappinspections/edit_packing_details">
				<div id="packing_details" class="progress-bar progress-bar-danger wd14" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" >
		...
		<a href="<?php echo $this->request->getAttribute('webroot');?>oldappinspections/edit_laboratory_details">
			<div id="laboratory_details" class="progress-bar progress-bar-danger wd14" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" >
		...
		<?php //if($ca_bevo_applicant == 'no') { ?>
			<a href="<?php echo $this->request->getAttribute('webroot');?>oldappinspections/edit_tbl_details">
				<div id="tbl_details" class="progress-bar progress-bar-danger wd14" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" >
...
<?php echo $this->Html->script('element/auth_old_applications_elements/progress_bar/inspection_progress_bar'); ?>
