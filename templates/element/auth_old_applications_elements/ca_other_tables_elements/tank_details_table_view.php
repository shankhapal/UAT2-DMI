	...
	<table id="tank_table" class="table table-stripped table-bordered">
		...
		<div id="tanks_each_row">
			...
			<tr>
				...
				<td>
					<a href="#" class="edit_tank_id far fa-edit tank_edit" id="<?php echo $each_tank['id']; ?>" ></a> |
					<a href="#" class="delete_tank_id far fa-trash-alt tank_delete" id="<?php echo $each_tank['id']; ?>" ></a>


					<?php //echo $this->Html->link('', array('controller' => 'customerforms', 'action'=>'edit_tank_id',$each_tank['Dmi_all_tanks_detail']['id']),array('class'=>'far fa-edit tank_edit', 'title'=>'Edit')); ?>
					<?php //echo $this->Html->link('', array('controller' => 'customerforms', 'action'=>'delete_tank_id',$each_tank['Dmi_all_tanks_detail']['id']),array('class'=>'far fa-trash-alt tank_delete', 'title'=>'Delete')); ?>
				</td>
			</tr>
			<?php $i=$i+1; } ?>
		...
		<?php if($this->Session->read('edit_tank_id') != null){?>
			<tr>
				<td></td>
				...
				<td><?php echo $this->Form->control('tank_shape', array('type'=>'select', 'id'=>'tank_shape', 'value'=>$tank_shape_value_edit, 'options'=>$tank_shapes, 'escape'=>false, 'class'=>'input-field', 'label'=>false)); ?></td>
		...
		<?php }else{?>
			<div id="add_new_row">
				<tr>
					...
					<td><?php echo $this->Form->control('tank_shape', array('type'=>'select', 'id'=>'tank_shape', 'options'=>$tank_shapes, 'escape'=>false, 'class'=>'input-field', 'label'=>false)); ?></td>
					...
					<td>
						<div class="form-buttons"><a href="#" id="add_tank_details" >Add</a></div>
...
<?php echo $this->Html->script('element/auth_old_applications_elements/ca_other_tables_elements/tank_details_table_view') ?>
