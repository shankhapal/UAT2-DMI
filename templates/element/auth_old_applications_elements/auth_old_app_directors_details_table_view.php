		...
		<table id="directors_details_table" class="table table-bordered table-striped">
			...
			<div id="directors_each_row">
				...
				<?php if($this->Session->read('edit_directors_details_id') != null){?>
					<tr>
						<td></td>
						<td class="mwd100"><?php echo $this->Form->control('d_name', array('type'=>'text', 'id'=>'d_name', 'value'=>$find_directors_details['d_name'], 'escape'=>false, 'class'=>'input-field', 'label'=>false)); ?></td>
						<td><?php echo $this->Form->control('d_address', array('type'=>'text', 'id'=>'d_address', 'value'=>$find_directors_details['d_address'], 'escape'=>false, 'class'=>'input-field', 'label'=>false)); ?></td>
						<td>
							<div class="form-buttons"><a href="#" id="save_directors_details">Save</a></div>
...
<?php echo $this->Html->script('element/auth_old_applications_elements/auth_old_app_directors_details_table_view'); ?>
