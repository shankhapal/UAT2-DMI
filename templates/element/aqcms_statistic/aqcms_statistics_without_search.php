			...
			<div class="stats-card-inner box-8">
				...
				<div class="stats-card-back" id="myForm7">
					...
					<ul class="ul">
						...
						<li class="badge bg-light mb-3"><a href="<?php echo $this->request->getAttribute('webroot');?>reports/payment_details_report//<?= base64_encode("Chemist Approval")?>"><span class="text-primary"></span> Renewal Application Chemist : <?php echo $statistics_counts[0]['reve_app_chem']; ?></a></li>
						<li class="badge bg-light mb-3"><a href="<?php echo $this->request->getAttribute('webroot');?>reports/payment_details_report//<?= base64_encode("Change Request")?>"><span class="text-primary"></span> Renewal Application Change : <?php echo $statistics_counts[0]['reve_app_change']; ?></a></li>
						<li class="badge bg-light mb-3"><a href="<?php echo $this->request->getAttribute('webroot');?>reports/payment_details_report//<?= base64_encode("Advance Payment")?>"><span class="text-primary"></span> Renewal Application Advance : <?php echo $statistics_counts[0]['reve_app_adv']; ?></a></li>
					</ul>
				</div>
			</div>
		</div>
