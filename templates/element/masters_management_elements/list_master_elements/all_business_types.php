...
<tbody>
	...
	if (!empty($all_records)) {
		...
		<tr>
			...
			<td><?php echo $each_record['business_type'];?></td>
			<td>
				...
				<?php echo $this->Html->link('', array('controller' => 'masters', 'action'=>'deleteMasterRecord', $each_record['id']),array('class'=>'glyphicon glyphicon-remove delete_buisness_type','title'=>'Delete')); ?>
			</td>
		</tr>
	<?php $sr_no++; } } ?>
</tbody>
